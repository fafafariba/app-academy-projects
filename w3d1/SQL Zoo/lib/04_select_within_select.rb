...
def sparse_continents
  ...
  # i.e. if continent has single country that has pop greater than 25
  # million, then not all of its countries do not have less than 25 pop
  execute(<<-SQL)
  SELECT
